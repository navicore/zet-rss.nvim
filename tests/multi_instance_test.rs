...
fn test_multiple_viewer_instances() {
    ...
    let cache = zetrss::cache::TextCache::with_base_dir(temp_dir.path().to_path_buf()).unwrap();
    ...
    for entry in entries {
        ...
        assert!(
            !name_str.starts_with("zetrss_open_url_") && !name_str.starts_with("zetrss_note_path_"),
